...
FILE_DEVOPS_ENV=url to docker-compose .env file
FILE_DEVOPS_COMPOSE=url to docker-compose .yml file
...
PROXYMNGR_DB_USER=username
PROXYMNGR_DB_PASSWORD=password
...
VSCODE_ROOT_SUDO_USER=username
VSCODE_ROOT_SUDO_PASSWORD=password
VSCODE_ROOT_SUDO_PGID=usergroup
VSCODE_ROOT_SUDO_PUID=usergroup
